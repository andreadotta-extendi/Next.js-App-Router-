...
import MUIFilledInput, { FilledInputProps } from "@mui/material/FilledInput";
...
import MUIPortal, { PortalProps } from "@mui/material/Portal";
...
import MUIStepIcon, { StepIconProps } from "@mui/material/StepIcon";
...
import CustomCreativeCheckbox, {
  CreativeCheckboxProps,
} from "@/components/Shared/ui/CreativeCheckbox";
...
export const CardMedia = (props: CardMediaProps) => <MUICardMedia {...props} />;
...
export const Fab = (props: FabProps) => <MUIFab {...props} />;
...
export const FormLabel = (props: FormLabelProps) => <MUIFormLabel {...props} />;
export const Grid = (props: GridProps) => <MUIGrid {...props} />;
export const ImageList = (props: ImageListProps) => <MUIImageList {...props} />;
...
export const ModalMetadata = (props: ModalMetadataProps) => (
  <CustomModalMetadata {...props} />
);
export const CreativeCheckbox = (props: CreativeCheckboxProps) => (
  <CustomCreativeCheckbox {...props} />
);
