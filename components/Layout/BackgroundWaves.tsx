...
const BackgroundWaves: React.FC<WaveProps> = ({ wave }) => {
  return (
    <React.Fragment>
      {wave === "login" && (
        <img
      ...
      {wave === "onboardingSteps" && (
        <img
          className="hidden md:block fixed right-0 left-0 bottom-[12%] -z-10 w-full opacity-40"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/ecd3b26096f0fdf57faacea59f607efbf3be43d375ff4ce11af4faefff0c969b?placeholderIfAbsent=true&apiKey=ae92917785e7425fbb91907da8ebf914"
        />
      )}

      {wave === "onboardingEnd" && (
        <img
          className="hidden md:block fixed pr-12 left-0 bottom-[12%] -z-10 w-full"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/2d310c1fa586282d22a6bf83f642e5b26627f7dc6b146c5e619e3c6cfd205001?placeholderIfAbsent=true&apiKey=ae92917785e7425fbb91907da8ebf914"
        />
      )}
    </React.Fragment>
  );
