...
const steps = [
  {
    ...
    image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/81ba2ff2f482cdc7ab8254d93f7fb0ab94a0d0e4c3a0d8a6f8b4875c84ddeb60?placeholderIfAbsent=true&apiKey=ab14136582c84aab8af41f16349d0438'
  },
  {
    courseType: 'Masterclass Live',
    ...
    image: 'https://images.unsplash.com/photo-1487954277007-8c2d6710c312?q=80&w=2736&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  },
  {
    courseType: 'Masterclass Live',
...
export function SwipableCatalogCarousel() {
  ...
  return (
    <div className="flex flex-col justify-center mt-4 w-full">
        <Grid container spacing="0" className="bg-paper rounded-xl text-center overflow-hidden h-[450px]">
            <Grid item md={6}>
                <div className="flex flex-col flex-1 shrink justify-center px-8 py-10">
                    <div className="flex flex-col w-full gap-4">
                    <Chip
                        label={<Typography variant="caption-500">{steps[activeStep].courseType}</Typography>}
                        size="medium"
                        variant="filled"
